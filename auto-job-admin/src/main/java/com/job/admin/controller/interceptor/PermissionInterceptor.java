package com.job.admin.controller.interceptor;

import com.job.admin.controller.annotation.PermessionLimit;
import com.job.admin.core.conf.JobAdminConfig;
import com.job.admin.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    static {
        String username = JobAdminConfig.getAdminConfig().getLoginUsername();
        String password = JobAdminConfig.getAdminConfig().getLoginPassword();
